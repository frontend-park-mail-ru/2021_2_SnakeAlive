(function () {
	...
	templates['county_sights'] = template({
		compiler: [8, '>= 4.3.0'],
		main: function (container, depth0, helpers, partials, data) {
			...
			return (
				...
				container.escapeExpression(
					((helper =
						(helper =
							lookupProperty(helpers, 'country') ||
							(depth0 != null ? lookupProperty(depth0, 'country') : depth0)) != null
							? helper
					...
					typeof helper === 'function'
						? helper.call(depth0 != null ? depth0 : container.nullContext || {}, {
								...
								hash: {},
								data: data,
								loc: { start: { line: 4, column: 41 }, end: { line: 4, column: 52 } },
						  })
						: helper)
				) +
			...
			return (
				...
				((stack1 = lookupProperty(helpers, 'each').call(
					...
					depth0 != null ? lookupProperty(depth0, 'tags') : depth0,
					{
						...
						inverse: container.noop,
						data: data,
						loc: { start: { line: 21, column: 12 }, end: { line: 23, column: 21 } },
					}
				)) != null
					? stack1
					: '') +
				...
				alias4(
					...
					typeof helper === alias3
						? helper.call(alias1, {
								...
								hash: {},
								data: data,
								loc: { start: { line: 29, column: 29 }, end: { line: 29, column: 39 } },
						  })
						: helper)
				) +
				'" class="font__link">' +
				alias4(
					...
					typeof helper === alias3
						? helper.call(alias1, {
								...
								hash: {},
								data: data,
								loc: { start: { line: 29, column: 60 }, end: { line: 29, column: 70 } },
						  })
						: helper)
				) +
				...
				alias4(
					...
					typeof helper === alias3
						? helper.call(alias1, {
								...
								hash: {},
								data: data,
								loc: { start: { line: 32, column: 16 }, end: { line: 32, column: 27 } },
						  })
						: helper)
				) +
				'\n            </div>\n        </div>\n    </div>\n</div>\n'
		...
		2: function (container, depth0, helpers, partials, data) {
			...
			return (
				((stack1 = lookupProperty(helpers, 'if').call(
					alias1,
					depth0 != null ? lookupProperty(depth0, 'main') : depth0,
					{
						name: 'if',
						hash: {},
				...
				container.escapeExpression(
					...
					typeof helper === 'function'
						? helper.call(depth0 != null ? depth0 : container.nullContext || {}, {
								...
								hash: {},
								data: data,
								loc: { start: { line: 22, column: 59 }, end: { line: 22, column: 67 } },
						  })
						: helper)
				) +
				'</div>\n'
		...
		main: function (container, depth0, helpers, partials, data) {
			...
			return (stack1 = lookupProperty(helpers, 'each').call(
				...
				depth0 != null ? lookupProperty(depth0, 'cards') : depth0,
				{
					...
					inverse: container.noop,
					data: data,
					loc: { start: { line: 1, column: 0 }, end: { line: 37, column: 9 } },
				}
			)) != null
				? stack1
				: '';
