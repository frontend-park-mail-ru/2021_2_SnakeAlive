...
export default class PageReducer {
    ...
    createInitPage() {
        console.log(this)
        let countryReducer = new CountryReducer(this.#storage, this.#dispatcher);
        countryReducer.init();

        let countryHolderView = new CountryHolderView(this.#storage, this.#dispatcher);
        countryHolderView.init();

        let countryCardsHolderView = new CountryCardsHolderView(this.#storage, this.#dispatcher);
