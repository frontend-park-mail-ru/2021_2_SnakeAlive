...
const newInitCountryRequest = (name: string, id: string): Event => <Event>{
...
const newInitCountryResponse = (name: string, id: string): Event => <Event>{
...
const newGetCountryCardsRequest = (countryID: string): Event => <Event>{
...
const newGetCountryCardsResult = (): Event => <Event>{
...
const newGetCountryCardsError = (error: Error): Event => <Event>{
